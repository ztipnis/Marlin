...
#define STRING_CONFIG_H_AUTHOR "(zatipnis, just another 3d printer)" // Who made the changes.
...
// #define BOOTSCREEN_TIMEOUT 1250
...
#define MACHINE_UUID "b330ff10-580e-4248-b12a-8d3a3f2ef9f1"
...
#define HOTEND_OFFSET_X { 0, -19 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -2.650 }  // (mm) relative Y-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  15.09,  15.09 }
    #define DEFAULT_Ki_LIST {   0.90,   1.80 }
    #define DEFAULT_Kd_LIST { 63.25, 63.25 }
  #else
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 415, 208 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 6, 25, 35 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 25, 5000, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -66.9, 13.249, -2.8 }
